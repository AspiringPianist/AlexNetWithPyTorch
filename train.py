...
from dataset.cifar_10_import import CIFARDataset
from torch.utils.data import DataLoader
from tqdm import tqdm # Vieweing progress, loading bars, etc
...
if __name__ == "__main__":
    ...
    optimizer = Adam(alexNet.parameters(), lr = LEARNING_RATE)
